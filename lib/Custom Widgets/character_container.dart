...
import 'package:flutter_task/character.dart';

class CharacterContainer extends StatelessWidget {
  CharacterContainer({required this.character, required this.size});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border:
              Border.all(color: character.getHouseSecondaryColor(), width: 2.5),
          boxShadow: [
            BoxShadow(
